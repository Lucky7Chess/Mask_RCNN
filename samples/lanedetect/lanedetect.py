...
Written by Waleed Abdulla Edited by Kenneth Shaw for lane detection
...
class LanedetectDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("lanedetect", 1, "lanedetect")
